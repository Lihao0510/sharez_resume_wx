...

{
  ...
  methods: {
    ...
    fastLogin: function fastLogin() {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$uni$login, _yield$uni$login2, err, res, openIdRes;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (

                  uni.login({
                    provider: 'weixin' }));case 3:_yield$uni$login = _context.sent;_yield$uni$login2 = _slicedToArray(_yield$uni$login, 2);err = _yield$uni$login2[0];res = _yield$uni$login2[1];if (!

                err) {_context.next = 9;break;}throw (
                  new Error('获取临时授权码失败!'));case 9:_context.next = 11;return (

                  _http_request.default.post('wechat/login', {
                    code: res.code }));case 11:openIdRes = _context.sent;

                console.log('获取的OpenId ==>', openIdRes);if (!(
                openIdRes.code !== 200)) {_context.next = 15;break;}throw (
                  new Error(openIdRes.message));case 15:_context.next = 20;break;case 17:_context.prev = 17;_context.t0 = _context["catch"](0);


                uni.showToast({
                  title: _context.t0.message,
                  icon: "none",
                  duration: 2000 });case 20:case "end":return _context.stop();}}}, _callee, null, [[0, 17]]);}))();
